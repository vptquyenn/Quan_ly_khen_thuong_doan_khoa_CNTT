...
if(isset($_POST['btnExport'])){
    ...
    $result = $connect->query("SELECT list_439dkhd.id, list_439dkhd.mssv, list_439dkhd.ho_ten, list_439dkhd.lop, list_439dkhd.gioi_tinh, list_439dkhd.khoa, list_hoatdong.tenhoatdong, list_hoatdong.noidunghoatdong, list_hoatdong.hocki, list_hoatdong.ngay_bd, list_chitiet.trang_thai
                                FROM list_439dkhd
...
<body onload="time()">
        ...
        <div class=" container-header-all">
            <div class="container navbar-header-header">
                ...
                <div class="navbar-collaps col-4" id="myNavbar" style="font-size: 12px;">
                    ...
                    <div class="me-1 col-3 nav_item_link">
                        <a class="header-navbar-link"  href="dangki439.php" style="padding-bottom: 16px; margin-bottom: 35px; border-bottom: 3px solid white; font-weight: 700;">DS Hoạt Động</a>
                    </div>
                    <div class="me-1 col-3 nav_item_link">
    ...
    <div class="container-fluid al">
        ...
        <a href="add_dangki439.php" class="nv dangki" data-toggle="tooltip" data-placement="bottom" title="Đăng kí tham gia hoạt động">
            ...
            <tbody>
				<?php foreach($list_439dkhd as $dangki439): ?>
					<tr>
						...
						<td>
							<form class="delete" action="<?=BASE_URL_PATH . 'delete_dangki439.php'?>" method="POST" style="display: inline;">
								<input type="hidden" name="id" value="<?=$dangki439->getId()?>">
								<button type="submit" class="btn btn-xs btn-danger" name="delete-dangki">
									<i alt="Delete" class="fa fa-trash"> Hủy Đăng Ký</i>
								</button>
							</form>
						</td>
					</tr>
